...
```{r sir_pareto}
r_eff1 <- loo::relative_eff(x = exp(-log_weights))
psis1 <- loo::psis(log_weights, r_eff = r_eff1)
print(psis1)
```
...
r_eff2 <- loo::relative_eff(x = exp(-log_weights))
psis2 <- loo::psis(log_weights, r_eff = r_eff2)
print(psis2)
```
...
r_eff3 <- loo::relative_eff(x = exp(-log_weights))
psis3 <- loo::psis(log_weights, r_eff = r_eff3)
print(psis3)
```
