...
```{r sir_compute_errors, fig.width=8.2, fig.height=4.5}
mean_abs_error <- compute_errors(sims$sims, "mean")
max_abs_error <- compute_errors(sims$sims, "max")
plot_sim_errors(atols, rtols, mean_abs_error)
plot_sim_errors(atols, rtols, max_abs_error)
```
