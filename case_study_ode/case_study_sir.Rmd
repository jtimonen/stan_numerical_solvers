...
"
sir_obsdata <- "  int<lower=0> y[N];"
sir_odesolve <- "  vector[3] x[N] = ode_rk45_tol(SIR, x0, t0, t, RTOL, ATOL, 
...
source("R/odeadapt.R")
models <- create_cmdstan_models(sir_funs, sir_data, sir_tdata, sir_obsdata,
                                sir_pars, sir_tpars,
...
simulate_sir <- function(params, t_sim=NULL, RTOL = 1e-6, ATOL = 1e-6,
  ...
  sim <- models$sim$generate_quantities(
    data = stan_data, 
